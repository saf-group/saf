...
|              版本               |                            概述                              |                       缺点/问题                       |
| ------------------------------------ | ------------------------------------------------------------------- | --------------------------------------------------- |
| saf-1.0.0                      |      基本功能                               | 工程结构不合理，saf-boot-starter,saf-project,saf-samples应该拆分成3个工程。 saf-boot-starter给业务开发者使用；saf-project是架构师使用；saf-samples是使用范例。拆分后才能达到架构师和业务的完全解耦，互不影响。 |
| saf-1.0.3                      |      拆分成三个工程：saf-boot-starter, saf(saf-project), saf-samples                               | prometheus抽象的修改有bug。 |
