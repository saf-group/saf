package com.future.saf.sample.db.mapper.malldb;

import org.apache.ibatis.annotations.Param;
import org.apache.ibatis.annotations.Select;

import com.future.saf.sample.db.mapper.malldb.model.ShopModel;
...
public interface ShopMapper {
	...
	@Select("<script>" + "SELECT " + COLUMNS + " FROM shop WHERE id IN "
