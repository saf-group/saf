package com.future.saf.web.basic.util;
...
public class HttpUtil {
	...
	public static void main(String[] args) {
		...
		System.out.println(getPatternUrl(
				"/api/news/$post$appCurVersion=3.3.5.6&exposureTime=0&androidId=7bb2432b55d828f8&imei=868460031387753&userId=94375465&typeId=19&channel=F2qdx360&os=Android/"));
		System.out.println(getPatternUrl("/dexgp.php/"));
		System.out.println(getPatternUrl("/phpMyAdmin/scripts/setup.php/"));
	}

	private static final String[] IGNORE_POST_FIX = new String[] { ".php", ".jpg", ".png", ".jpeng", ".css", ".js",
			".jsp" };
